	           ...
	           public void actionPerformed(java.awt.event.ActionEvent e) {
	        	   ...
	        	   if(eingabe+td.selectCount() <= ticketsToSell) {
	        		   while(eingabe > 0) {
	        			   ...
	        			   int count = td.insert(ticket);
	        			   if(count >= 0) {
	        				   anzahlLabel.setText(Integer.toString(ticketsToSell-count));
	        				   message.setText("Das Ticket wurde gekauft!");
	        			   }
	        		   }
	        		   
	        	   }else {
	        		   message.setText("So viele Tickets sind nicht vorhanden!");
	        	   }
